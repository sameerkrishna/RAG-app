...
async function hybridQueryCollection(collection, queryText, queryEmbedding, topK = 5) {
  try {
    const search = new Search().rank(new Rrf({
      ranks: [
