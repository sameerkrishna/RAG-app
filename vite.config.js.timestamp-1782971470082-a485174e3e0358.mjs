...
var genAI, embeddingModel, PROJECT_ID, LOCATION, vertexAI, BATCH_SIZE2, PARALLEL_CALLS, OUTPUT_DIMENSIONS, GROUP_WAIT_MS;
var init_embeddingService = __esm({
  "server/services/embeddingService.js"() {
    ...
    genAI = null;
    embeddingModel = null;
    PROJECT_ID = "project-d48e2f39-2685-4746-aa0";
